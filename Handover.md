...
|Optimization of HO problem using Q-Learning for LTE network|Q-Learning, LTE Hard HO, RSRP based TTT Window, Integrator HO, LTE Hard HO with average RSRP Constraint|use Q-learning to find the optimal parameter of HO, such as HOM, TTT, the number of HO and throughput| The reward function is related to the number of HO, system throughput and delay. This work compare the performance of 4 standard LTE HO algorithm using optimal Parameter(HOM and TTT)|
